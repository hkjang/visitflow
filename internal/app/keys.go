...
func (s *Server) apiKeyPolicy(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, map[string]any{"allowedScopes": strings.Fields(allowed), "defaultExpiryDays": days, "maxActiveKeys": maxActive, "mcpOAuth": s.mcpOAuthInfo(r.Context())})
}
