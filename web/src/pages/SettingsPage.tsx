...
const fields: Record<string, Field[]> = {
  general: [
    { key: "general.service_name", label: "서비스 이름" }, { key: "general.company_name", label: "회사/조직명" }, { key: "general.base_url", label: "외부 기준 URL", help: "모바일 방문증 및 MMS QR 이미지의 공개 기준 URL. 예: https://visit.company.intra" }, { key: "general.default_locale", label: "기본 언어" },
  ],
  oidc: [
