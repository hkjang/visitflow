...
export function VisitsPage() {
  ...
  const reissue = async (participantId: string) => { const result = await postJSON<{ passUrl: string }>(`/api/v1/visitor-visits/${participantId}/qr/reissue`, {}); await navigator.clipboard.writeText(result.passUrl); setNotice("새 모바일 방문증 URL을 복사했습니다."); if (detail) await view(detail.visit.id); };
